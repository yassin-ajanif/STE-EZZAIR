...
public partial class DatePresetChipsModel : ObservableObject
{
    ...
    [ObservableProperty] private string _btnYesterday = string.Empty;
    ...
    [ObservableProperty] private bool _presetYesterdayActive;
    ...
    private void RefreshLabels()
    {
        ...
        BtnYesterday = _locale.T("Reports_PresetYesterday");
    ...
    private void SetActive(DateRangePreset preset)
    {
        ...
        PresetYesterdayActive = preset == DateRangePreset.Yesterday;
    ...
    [RelayCommand]
    private void SetYesterday() => Apply(DateRangePreset.Yesterday);
